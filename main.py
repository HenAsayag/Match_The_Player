    ...
    def get_key_at_pos(self, pos):
        for rect, key in self.key_rects:
            if rect.collidepoint(pos):
                return 'BACKSPACE' if key == '←' else key
        return None
...
button_spacing = 20  
button_y_start = 500  high_score_easy_button_rect = pygame.Rect((5, 150), (200, 60))
...
running = True
balls = []  
saved = False  key_repeat_delay = 300  
...
while running:
    ...
    display_player_name(player_data['name']    pygame.display.flip()
    clock.tick(60)
