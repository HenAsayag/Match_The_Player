...
points_font = pygame.font.Font(PATH + "OzradCLM.otf", 100)
input_font = pygame.font.Font(PATH + "nrkis.ttf", 50)
large_font = pygame.font.Font(PATH + "nrkis.ttf", 60)
player_name_font = pygame.font.Font(PATH + "nrkis.ttf", 30)
player_name_font_2 = pygame.font.Font(PATH + "OzradCLM.otf", 28)

# === IMAGES ===
card_image = pygame.transform.scale(pygame.image.load(PATH + 'card.png'), (294, 408))
tutorial_button_image = pygame.transform.scale(
    pygame.image.load(PATH + 'tutorial_button.png'), (348, 123)
)
...
background_images = {
    'mode1': pygame.transform.scale(
        pygame.image.load(PATH + 'background1.png'), (SCREEN_WIDTH, SCREEN_HEIGHT)
    ),
    'mode2': pygame.transform.scale(
        pygame.image.load(PATH + 'background2.png'), (SCREEN_WIDTH, SCREEN_HEIGHT)
    )
}

home_background = pygame.transform.scale(
    pygame.image.load(PATH + 'home_background.png'), (SCREEN_WIDTH, SCREEN_HEIGHT)
)
rules_image = pygame.transform.scale(
    pygame.image.load(PATH + 'rules.png'), (SCREEN_WIDTH, SCREEN_HEIGHT)
)
mode_selection_background = pygame.transform.scale(
    pygame.image.load(PATH + 'mode_selection_background.png'), (SCREEN_WIDTH, SCREEN_HEIGHT)
)
difficulty_selection_background = pygame.transform.scale(
    pygame.image.load(PATH + 'difficulty_selection_background.png'), (SCREEN_WIDTH, SCREEN_HEIGHT)
)
...
name_input_background = pygame.transform.scale(
    pygame.image.load(PATH + 'name_input_background.png').convert_alpha(),
    (SCREEN_WIDTH, SCREEN_HEIGHT)
)

high_score_background = pygame.transform.scale(
    pygame.image.load(PATH + 'high_score_background.png'),
    (SCREEN_WIDTH, SCREEN_HEIGHT)
)
...
def play_sound(sound, muted_flag):
    if not muted_flag:
        pygame.mixer.stop()
        sound.play()
...
def clean_player_name(name: str) -> str:
    # Remove (something), digits, underscores, and trim
    name = re.sub(r'\(.*?\)', '', name)
...
def display_player_name(player_name: str):
...
def display_highscore(high_score):
    high_score_text = player_name_font.render(f"{high_score}", True, pygame.Color('white'))
    screen.blit(high_score_text, (1110, 37))
...
corner_images = {
    RED: pygame.transform.scale(
        pygame.image.load(PATH + 'corner_red.png').convert_alpha(), (329, 297)
    ),
    BLUE: pygame.transform.scale(
        pygame.image.load(PATH + 'corner_blue.png').convert_alpha(), (379, 339)
    ),
    YELLOW: pygame.transform.scale(
        pygame.image.load(PATH + 'corner_yellow.png').convert_alpha(), (297, 325)
    ),
    GREEN: pygame.transform.scale(
        pygame.image.load(PATH + 'corner_green.png').convert_alpha(), (327, 295)
    )
}
...
corners = {
    ...
    "bottom_right": (
        (SCREEN_WIDTH - CORNER_SIZE) - 16,
        (SCREEN_HEIGHT - CORNER_SIZE) + 13,
        CORNER_SIZE,
        CORNER_SIZE,
        GREEN
    ),
...
# === NAME MAPPING & COLOR MAP ===
# (נשאר כמו שהיה אצלך – לא נגעתי בלוגיקה עצמה מלבד סידור)
name_mapping = {
    "אאוג'ן_טריקה.png": 'image_1.png',
    'אבי_בנימין_(כדורגלן).png': 'image_2.png',
    'אבישי_כהן_(כדורגלן).png': 'image_3.png',
    'אברהם_בית_הלוי.png': 'image_4.png',
    'אדוארדו_גררו.png': 'image_5.png',
    'אדווין_גיאסי.png': 'image_6.png',
    'אדי_גוטליב.png': 'image_7.png',
    'אהרן_אמר.png': 'image_8.png',
    'אובונג_מוזס_אקפאי.png': 'image_9.png',
    'אוסקר_גלוך.png': 'image_10.png',
    'אופק_ביטון.png': 'image_11.png',
    'אור_אינברום.png': 'image_12.png',
    'אורי_אוזן.png': 'image_13.png',
    'אושר_דוידה.png': 'image_14.png',
    'אושרי_גיטא.png': 'image_15.png',
    'איאד_אבו_עביד.png': 'image_16.png',
    'איבזיטו_אוגבונה.png': 'image_17.png',
    'איברהים_באנגורה.png': 'image_18.png',
    'איוואן_גצקו.png': 'image_19.png',
    'אייל_בן_עמי.png': 'image_20.png',
    "אייל_ברקוביץ'.png": 'image_21.png',
    'אייל_גולסה.png': 'image_22.png',
    'איציק_כהן_(בלם).png': 'image_23.png',
    'איתן_טיבי.png': 'image_24.png',
    'אלון_חרזי.png': 'image_25.png',
    'אלי_אוחנה.png': 'image_26.png',
    'אלי_דסה.png': 'image_27.png',
    'אלי_כהן_(מאמן).png': 'image_28.png',
    'אליניב_ברדה.png': 'image_29.png',
    'אליסון_דוס_סנטוס_(כדורגלן).png': 'image_30.png',
    'אלירן_דנין.png': 'image_31.png',
    'אלירן_חודדה.png': 'image_32.png',
    'אלכסנדר_אובארוב.png': 'image_33.png',
    "אלכסנדר_בולייביץ'.png": 'image_34.png',
    "אלן_אוז'בולט.png": 'image_35.png',
    'אנדרס_טונייס.png': 'image_36.png',
    'אנתוני_אנאן.png': 'image_37.png',
    'אסי_דומב.png': 'image_38.png',
    'אפולה_אדל.png': 'image_39.png',
    'ארון_אולנארה.png': 'image_40.png',
    'אריק_בנדו.png': 'image_41.png',
    'בוני_גינצבורג.png': 'image_42.png',
    'בירם_כיאל.png': 'image_43.png',
    'בן_ביטון.png': 'image_44.png',
    'ברוך_דגו.png': 'image_45.png',
    'ברק_בדש.png': 'image_46.png',
    'ברק_יצחקי.png': 'image_47.png',
    'ברק_לוי.png': 'image_48.png',
    "ג'וניור_ויסה.png": 'image_49.png',
    "ג'ונתן_אסוס.png": 'image_50.png',
    "ג'ורג'ה_יובאנוביץ'.png": 'image_51.png',
    'גדי_ברומר.png': 'image_52.png',
    'גודסוויי_דוניו.png': 'image_53.png',
    'גיא_אסולין.png': 'image_54.png',
    'גיא_בדש.png': 'image_55.png',
    'גיא_חיימוב.png': 'image_56.png',
    'גיורא_אנטמן.png': 'image_57.png',
    'גיל_יצחק.png': 'image_58.png',
    'גילי_ורמוט.png': 'image_59.png',
    'גל_אלברמן.png': 'image_60.png',
    'דאגלס_דה_סילבה.png': 'image_61.png',
    'דדי_בן_דיין.png': 'image_62.png',
    'דוד_אמסלם_(כדורגלן).png': 'image_63.png',
    'אברהם_גרנט.png': 'image_64.png',
    'דודו_אוואט.png': 'image_65.png',
    'דודו_ביטון.png': 'image_66.png',
    'דודו_דהאן.png': 'image_67.png',
    'דור_אלו.png': 'image_68.png',
    'דור_חוגי.png': 'image_69.png',
    'דור_כוכב.png': 'image_70.png',
    'דיוגו_ורדשקה.png': 'image_71.png',
    'דינו_אנדלובו.png': 'image_72.png',
    'דן_איינבינדר.png': 'image_73.png',
    'דן_ביטון_(כדורגלן).png': 'image_74.png',
    'דני_איימוס.png': 'image_75.png',
    "דני_הוצ'קו.png": 'image_76.png',
    'דניאל_בריילובסקי.png': 'image_77.png',
    'דניאל_דה_רידר.png': 'image_78.png',
    'דניאל_הבר.png': 'image_79.png',
    'דניאל_פרץ.png': 'image_80.png',
    'דניאל_פרץ_(2000).png': 'image_81.png',
    'דניל_לסובוי.png': 'image_82.png',
    'דנילו_אספרייה.png': 'image_83.png',
    'דרק_בואטנג.png': 'image_84.png',
    'וינסנט_אניימה.png': 'image_85.png',
    "ז'והאן_אודל.png": 'image_86.png',
    "ז'ורז'יניו_(1991).png": 'image_87.png',
    "זאב_חיימוביץ'.png": 'image_88.png',
    'חיים_מגרלשוילי.png': 'image_89.png',
    'חסן_אבו_זייד.png': 'image_90.png',
    "חסן_בדג'ייב.png": 'image_91.png',
    'טל_בן-חיים_(1982).png': 'image_92.png',
    'טל_בן-חיים_(1989).png': 'image_93.png',
    "יואב_ג'ראפי.png": 'image_94.png',
    'יואב_זיו.png': 'image_95.png',
    'יוחנן_וולך.png': 'image_96.png',
    'יונתן_כהן.png': 'image_97.png',
    'יוסי_אבוקסיס.png': 'image_98.png',
    'יוריס_ואן_אובריים.png': 'image_99.png',
    'יניב_בריק.png': 'image_100.png',
    'יעקב_אסייג.png': 'image_101.png',
    'ירו_בלו.png': 'image_102.png',
    'ירוסלב_באקו.png': 'image_103.png',
    'כפיר_אדרי.png': 'image_104.png',
    'כפיר_אודי.png': 'image_105.png',
    'כריסטיאן_אלברס.png': 'image_106.png',
    'לואיס_הרננדס_רודריגס.png': 'image_107.png',
    'ליאור_אסולין.png': 'image_108.png',
    'ליביו_אנטל.png': 'image_109.png',
    'ליוואי_גארסיה.png': 'image_110.png',
    'מאור_בוזגלו.png': 'image_111.png',
    'מארק_ואליינטה.png': 'image_112.png',
    'מואנס_דבור.png': 'image_113.png',
    'מוחמד_אבו_פאני.png': 'image_114.png',
    'מוחמד_גדיר.png': 'image_115.png',
    'מוחמד_כליבאת.png': 'image_116.png',
    'מוטי_איוניר.png': 'image_117.png',
    'מוטי_ברשצקי.png': 'image_118.png',
    'מיכאיל_אוסינוב.png': 'image_119.png',
    'מיכאל_זנדברג.png': 'image_120.png',
    'מיקאל_אלפונס.png': 'image_121.png',
    'מיקו_בלו.png': 'image_122.png',
    'מני_בסון.png': 'image_123.png',
    "מקסים_גרצ'קין.png": 'image_124.png',
    'מרלון_דה_חסוס.png': 'image_125.png',
    "מרקו_יאנקוביץ'.png": 'image_126.png',
    'משה_בן_לולו.png': 'image_127.png',
    'מתן_אוחיון.png': 'image_128.png',
    'נטע_לביא.png': 'image_129.png',
    'ניב_זריהן.png': 'image_130.png',
    "ניר_דוידוביץ'.png": 'image_131.png',
    'סטיב_גורי.png': 'image_132.png',
    'סטפנוס_אתנסיאדיס.png': 'image_133.png',
    'עאיד_חבשי.png': 'image_134.png',
    'עדן_בן_בסט.png': 'image_135.png',
    'עודד_בלוש.png': 'image_136.png',
    'עומר_אצילי.png': 'image_137.png',
    'עומר_בוקסנבוים.png': 'image_138.png',
    'עומר_דמארי.png': 'image_139.png',
    'עומרי_גלזר.png': 'image_140.png',
    'עופר_טלקר.png': 'image_141.png',
    'עידן_ורד.png': 'image_142.png',
    'עידן_טל.png': 'image_143.png',
    'עמית_ביטון.png': 'image_144.png',
    'עמרי_אפק.png': 'image_145.png',
    'ערן_לוי_(כדורגלן).png': 'image_146.png',
    'פבלו_ברנדאן.png': 'image_147.png',
    'פטריק_טומאסי.png': 'image_148.png',
    'פלמן_גלבוב.png': 'image_149.png',
    "צ'יקו_אופואדו.png": 'image_150.png',
    'צבי_ארליך.png': 'image_151.png',
    'קייס_גאנם.png': 'image_152.png',
    'קמיל_ואצק.png': 'image_153.png',
    'קרלוס_גרסיה.png': 'image_154.png',
    'רביד_גזל.png': 'image_155.png',
    'רדובן_הרומאדקו.png': 'image_156.png',
    'רודי_חדד.png': 'image_157.png',
    'רונאלדו_ואסקס.png': 'image_158.png',
    'רוני_לוי.png': 'image_159.png',
    'רועי_גורדנה.png': 'image_160.png',
    'רז_מאיר.png': 'image_161.png',
    "ריצ'מונד_בואצ'י.png": 'image_162.png',
    'רמי_אבו_לבן.png': 'image_163.png',
    'רן_אבוקרט.png': 'image_164.png',
    'רן_בנימין.png': 'image_165.png',
    'רפי_אוסמו.png': 'image_166.png',
    'שאבייר_אנדרסון.png': 'image_167.png',
    'שביט_אלימלך.png': 'image_168.png',
    'שולי_גילארדי.png': 'image_169.png',
    'שון_גולדברג.png': 'image_170.png',
    'שון_וייסמן.png': 'image_171.png',
    'שחר_הירש.png': 'image_172.png',
    'שי_אליאס.png': 'image_173.png',
    'שי_הולצמן.png': 'image_174.png',
    'שלום_אביטן.png': 'image_175.png',
    'שלומי_אזולאי_(קשר).png': 'image_176.png',
    'שלומי_ארבייטמן.png': 'image_177.png',
    'שמעון_גרשון.png': 'image_178.png',
    'שרן_ייני.png': 'image_179.png',
    'תום_אלמדון.png': 'image_180.png'
}
...
class VirtualKeyboard:
    def __init__(self, screen_surf):
        ...
        self.key_size = (80, 80)
        self.margin = 21
        self.font = pygame.font.Font(PATH + "nrkis.ttf", 40)
        self.key_rects = []
        self.create_keys()
    ...
    def create_keys(self):
        ...
        row = -0.5
        col = 0
        total_width = 10 * (self.key_size[0] + self.margin) - self.margin
        ...
        for key in self.keys:
            if key == 'SPACE':
                ...
                self.key_rects.append(
                    (pygame.Rect(x, y, total_width, self.key_size[1]), key)
                )
                col += 10
            else:
                ...
                y = SCREEN_HEIGHT - (3 - row) * (self.key_size[1] + self.margin) - self.margin
                self.key_rects.append(
                    (pygame.Rect(x, y, self.key_size[0], self.key_size[1]), key)
                )
                col += 1
    ...
    def draw(self):
        for rect, key in self.key_rects:
            ...
            label = self.font.render(key, True, WHITE)
...
class Ball:
    def __init__(self, color, character_images_dict, card_img):
        self.color = color
        self.character = random.choice(list(character_images_dict.keys()))
        self.original_image = character_images_dict[self.character]
        self.image = pygame.transform.scale(self.original_image, (361, 246))
        self.card_image = card_img
        ...
        if self.original_character_name is None:
            ...
            if self.original_character_name not in character_color_map:
                print(f"Warning: Character {self.original_character_name} not found in character_color_map")
            else:
                possible_colors = [c for c, _ in character_color_map[self.original_character_name]]
                if self.color not in possible_colors:
                    print(
                        f"Warning: Character {self.original_character_name} color "
                        f"{self.color} does not match any color in character_color_map"
                    )

    def draw(self, screen_surf):
        card_rect = self.card_image.get_rect(center=(self.x, self.y))
        screen_surf.blit(self.card_image, card_rect)

        screen_surf.blit(
            self.image,
            (self.x - self.image.get_width() // 2,
             self.y - self.image.get_height() // 2 - 10)
        )
        ...
        name_text_rect = player_name_text.get_rect(
            center=(self.x, self.y + card_rect.height // 2 - 58)
        )
        screen_surf.blit(player_name_text, name_text_rect)
    ...
    def snap_to_corner(self):
        MARGIN = 50
        snapped = False
        for _, (x1, y1, width, height, color) in corners.items():
...
def create_new_ball(color, character_images_dict, card_img):
    ball = Ball(color, character_images_dict, card_img)
...
def create_parallel_balls(num_balls, color, character_images_dict, card_img):
    return [create_new_ball(color, character_images_dict, card_img) for _ in range(num_balls)]


def draw_corners(ball_obj):
    if ball_obj.dragging:
        for _, (x1, y1, width, height, color) in corners.items():
            if x1 <= ball_obj.x <= x1 + width and y1 <= ball_obj.y <= y1 + height:
                screen.blit(corner_images[color], (x1, y1))


# === HIGH SCORES (GIST) ===
HIGH_SCORES_EASY_URL = 'https://api.github.com/gists/...
HIGH_SCORES_HARD_URL = 'https://api.github.com/gists/...
HIGH_SCORES_IMPOSSIBLE_URL = 'https://api.github.com/gists/...'
...
def update_high_score(high_scores_list, new_score_entry):
    updated = False
    for score_entry in high_scores_list:
    ...
    if not updated:
        high_scores_list.append(new_score_entry)

    high_scores_list = sorted(high_scores_list, key=lambda x: x['score'], reverse=True)[:10]
    for index, score_entry in enumerate(high_scores_list):
        score_entry['rank'] = index + 1
    return high_scores_list


def display_high_score_rank(high_scores_list, player_high_score):
    sorted_high_scores = sorted(high_scores_list, key=lambda x: x['score'], reverse=True)
    player_rank = None
...
back_button_rect = pygame.Rect(550, 620, 150, 50).inflate(100, 20)
...
save_button_rect = pygame.Rect((SCREEN_WIDTH // 2 - 700, SCREEN_HEIGHT // 2 - 300), (400, 300))
continue_button_rect = pygame.Rect((SCREEN_WIDTH // 2 - 200, SCREEN_HEIGHT // 2 - 210), (400, 60))
input_rect = pygame.Rect((SCREEN_WIDTH // 2 - 200, SCREEN_HEIGHT // 2 - 120), (400, 100))
...
while running:
    for event in pygame.event.get():
        ...
        # ===== MAIN MENU MOUSE =====
              ...
              not game_active and
              not viewing_high_score and
              not choosing_mode and
              not viewing_rules and
              not entering_name and
              not choosing_difficulty):
        ...
        elif event.type == pygame.KEYDOWN and viewing_high_score:
        ...
        # ===== DIFFICULTY SELECTION =====
            ...
            if easy_button_rect.collidepoint(mouse_x, mouse_y):
                ...
                start_time = time.time()
                score = 0
                balls = create_parallel_balls(1, RED, character_images, card_image)
                next_ball_time = time.time() + random.uniform(2, 5)

            elif tutorial_button_rect.collidepoint(mouse_x, mouse_y):
                webbrowser.open("https://www.youtube.com/watch?v=rEm6cCNRX3Q")

        # ===== GAME EVENTS (DRAGGING BALLS) =====
        if game_active:
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                for ball in balls[:]:
                    if ball.dragging:
                        ...
                        correct = False
                        if ball.original_character_name in character_color_map:
                            for color, points in character_color_map[ball.original_character_name]:
                                in_correct_corner = any(
                                    True
                                    for _, (x1, y1, width, height, c) in corners.items()
                                    if x1 <= ball.x <= x1 + width
                                    and y1 <= ball.y <= y1 + height
                                    and c == color
                                )
    ...
    if game_active:
        ...
        if remaining_time <= 0:
            game_active = False
            entering_name = player_data['name'] == ''
        ...
        small_font = pygame.font.Font(PATH + 'OzradCLM.otf', 40)
        score_text = small_font.render(f"  : {score}", True, WHITE)
        timer_val = int(max(0, remaining_time))
        timer_text = small_font.render(f"    : {timer_val}", True, WHITE)
        ...
        if time.time() - points_change_time < 1:
            points_change_text = points_font.render(f"{points_change}", True, WHITE)
            points_change_rect = points_change_text.get_rect(
        ...
        screen.blit(name_input_background, (0, 0))
        ...
        screen.blit(
            high_score_text,
            (SCREEN_WIDTH // 2 - high_score_text.get_width() // 2, 50)
        )
        ...
        for index, entry in enumerate(top_scores):
            ...
            score_x = SCREEN_WIDTH // 2 - 370
            name_x = SCREEN_WIDTH - name_text.get_width() - 250
        ...
        screen.blit(easy_text, easy_button_rect.move(30, 10))
        screen.blit(hard_text, hard_button_rect.move(30, 10))
        screen.blit(impossible_text, impossible_button_rect.move(30, 10))
